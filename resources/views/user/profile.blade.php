            ...
            <div class="body">
                <div>
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#profile_settings" aria-controls="settings" role="tab" data-toggle="tab"><i class="material-icons">settings</i>Profile Settings</a></li>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane animated flipInY active" id="profile_settings" role="tabpanel">
                            <form class="form-horizontal" action="{{ route('user.profile.edit', ['user' => $user]) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="FirstName" name="first_name" placeholder="John" value="{{ $user->first_name }}"
                                            required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="Phone" name="phone_no" placeholder="+880-XXXXXXXXXX" value="{{ $user->phone }}"
                                            required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" id="DateOfBirth" name="date_of_birth" placeholder="YYYY-MM-DD" value="{{ $user->date_of_birth }}"
                                            required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane animated flipInY" id="change_password_settings">
                            <form class="form-horizontal" action="{{ route('user.change_password', ['user' => $user]) }}" method="POST">
                                @csrf @method('PATCH')
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="password" class="form-control" id="NewPasswordConfirm" name="NewPassword_confirmation" placeholder="New Password (Confirm)"
                                            required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @if (Auth::user()->hasRole('superadministrator'))
                            <div role="tabpanel" class="tab-pane animated flipInY" id="role_change">
                                ...
                                <hr/>
                                <form class="form-horizontal" action="{{ route('admin.user.change_roles', ['user' => $user]) }}" method="POST">
                                    @csrf @method('PUT')
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-3">
                                            @foreach ($roles as $role)
                                                <input type="checkbox" id="md_checkbox_{{ $loop->index }}" class="chk-col-light-green" name="roles[{{ $loop->index }}]" {{ $user->hasRole($role->name) ? 'checked': ''}} value="{{ $role->id }}" />
