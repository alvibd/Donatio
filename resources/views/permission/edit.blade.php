    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                <form method="POST" action="{{ route('admin.permission.update', ['permission' => $permission]) }}">
                    @csrf
                        <div class="col-sm-12">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                <input type="text" class="form-control" name="name" value="{{ $permission->display_name }}" required>
